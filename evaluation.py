...
from visualization import save_and_close_plot  # Importing the function from visualization
...
plt.tight_layout()
save_and_close_plot(os.path.join(output_dir, 'scatter_plots.png'), fig)  # Save and close the figure
